...
export const PRODUCTS_DATA: Product[] = [
  ...
  { slug: "nhan_vo_oc-005", name: "Nhẫn Vỏ Ốc Trắng Sóng Biển", collectionSlug: "nhan_vo_oc", price: "89.000 VND", description: "Nhẫn đơn giản với mặt vỏ sò hồng phấn nhẹ nhàng, gắn trên đế kim loại mạ vàng tinh tế. Tông màu pastel dịu dàng, dễ phối với nhiều loại trang phục, phù hợp đeo hàng ngày.", images: [SITE_IMAGES.collections.nhan_vo_oc_5], specifications: { dimensions: "Mặt sò 14–18mm, Size: 5–9", reference: "RRS-NH-005" }, featured: false },
  { slug: "nhan_vo_oc-006", name: "Nhẫn Vỏ Sò Kem Ngọc Trai", collectionSlug: "nhan_vo_oc", price: "119.000 VND", description: "Vỏ ốc xoắn tự nhiên màu nâu vàng ấm áp, mỗi chiếc mang hoa văn xoắn độc đáo riêng. Đế bạc mảnh mai tôn lên vẻ mộc mạc gần gũi với thiên nhiên của từng chiếc nhẫn.", images: [SITE_IMAGES.collections.nhan_vo_oc_6], specifications: { dimensions: "Ốc xoắn 12–16mm, Size: 5–9", reference: "RRS-NH-006" }, featured: false },
  { slug: "nhan_vo_oc-007", name: "Nhẫn Vỏ Sò Xám Ánh Ngọc", collectionSlug: "nhan_vo_oc", price: "129.000 VND", description: "Nhẫn thiết kế đôi với vỏ sò trắng nhỏ và hạt ngọc trai nước ngọt đặt cạnh nhau trên đế kim loại chung. Ý tưởng quà tặng ngọt ngào, biểu tượng cho sự gắn kết đôi lứa.", images: [SITE_IMAGES.collections.nhan_vo_oc_7], specifications: { dimensions: "Cụm 18–22mm, Size: 5–9", reference: "RRS-NH-007" }, featured: false },
  { slug: "nhan_vo_oc-008", name: "Nhẫn Vỏ Sò Đen Giọt Ngọc", collectionSlug: "nhan_vo_oc", price: "135.000 VND", description: "Mặt nhẫn vỏ điệp xà cừ màu xanh dương biển sâu huyền bí, ánh lên những tia sáng ngũ sắc dưới ánh đèn. Được đánh bóng thủ công, mỗi chiếc mang màu xanh tự nhiên không chiếc nào giống nhau.", images: [SITE_IMAGES.collections.nhan_vo_oc_8], specifications: { dimensions: "Mặt điệp 16–20mm, Size: 5–9", reference: "RRS-NH-008" }, featured: true },
  { slug: "nhan_vo_oc-009", name: "Nhẫn San Hô Biển Ngọc Hồng", collectionSlug: "nhan_vo_oc", price: "129.000 VND", description: "Nhẫn hình hoa nhỏ xinh ghép từ 5 cánh vỏ sò trắng mini, trung tâm là hạt cườm vàng lấp lánh. Dáng hoa nhẹ nhàng nữ tính, kích thước nhỏ gọn phù hợp đeo đi học hoặc đi làm.", images: [SITE_IMAGES.collections.nhan_vo_oc_9], specifications: { dimensions: "Hoa Ø14mm, Size: 5–9", reference: "RRS-NH-009" }, featured: false },
  { slug: "nhan_vo_oc-010", name: "Nhẫn Vỏ Sò Hồng Uốn Vàng", collectionSlug: "nhan_vo_oc", price: "119.000 VND", description: "Vỏ ốc tai tượng xà cừ tự nhiên lớn được bọc viền mạ vàng 14K sang trọng. Hình dáng độc đáo của vỏ ốc tai tượng tạo nên điểm nhấn thời trang ấn tượng và khác biệt.", images: [SITE_IMAGES.collections.nhan_vo_oc_10], specifications: { dimensions: "Mặt ốc 20–25mm, Size: 5–9", reference: "RRS-NH-010" }, featured: false },
  { slug: "nhan_vo_oc-011", name: "Nhẫn Vỏ Sò Xanh Ngọc Biển", collectionSlug: "nhan_vo_oc", price: "139.000 VND", description: "Nhẫn thiết kế đa tầng với nhiều vỏ sò nhỏ xếp chồng lên nhau tạo chiều sâu và hiệu ứng layering. Phong cách boho độc đáo, mỗi lớp vỏ sò có màu sắc và hình dáng khác nhau.", images: [SITE_IMAGES.collections.nhan_vo_oc_11], specifications: { dimensions: "Cụm layering 22–26mm, Size: 5–9", reference: "RRS-NH-011" }, featured: false },
  { slug: "nhan_vo_oc-012", name: "Nhẫn Ngọc Trai Đại Dương", collectionSlug: "nhan_vo_oc", price: "159.000 VND", description: "Mặt nhẫn vỏ sò trắng oval được bao quanh bởi hàng đá CZ lấp lánh như kim cương. Sự kết hợp giữa vẻ đẹp tự nhiên của biển cả và ánh sáng lộng lẫy tạo nên chiếc nhẫn sang trọng bậc nhất.", images: [SITE_IMAGES.collections.nhan_vo_oc_12], specifications: { dimensions: "Mặt oval 16×22mm, Size: 5–9", reference: "RRS-NH-012" }, featured: true },
  ...
  { slug: "gio_vo_so-007", name: "Kẹp Tóc Vỏ Sò Ngọc Biển", collectionSlug: "gio_vo_so", price: "79.000 VND / bộ", description: "Túi xách thủ công đan cói tự nhiên khảm vỏ sò biển, quai đôi chắc chắn tiện lợi. Kiểu dáng thoáng mát phù hợp đi biển hoặc dạo phố mùa hè.", images: [SITE_IMAGES.collections.tui_xach_7], specifications: { dimensions: "30×24×10cm, Quai dài 30cm", reference: "RRS-GI-007" }, featured: false },
  { slug: "gio_vo_so-008", name: "Kẹp Tóc San Hô Hồng Biển Dịu", collectionSlug: "gio_vo_so", price: "89.000 VND / chiếc", description: "Túi tote vải thô canvas tự nhiên thêu họa tiết vỏ sò và sóng biển bằng tay. Rộng rãi, bền chắc, phù hợp đi chợ, đi biển hay làm túi đựng đồ hàng ngày.", images: [SITE_IMAGES.collections.tui_xach_8], specifications: { dimensions: "35×38cm, Quai dài 55cm", reference: "RRS-GI-008" }, featured: false },
  { slug: "gio_vo_so-009", name: "Kẹp Càng Cua Vỏ Sò Ngọc Kem", collectionSlug: "gio_vo_so", price: "99.000 VND / chiếc", description: "Ví cầm tay nhỏ nhắn đính kín vỏ sò lấp lánh, đủ đựng điện thoại và ví nhỏ. Phong cách boho sang trọng, lý tưởng cho các buổi tiệc ngoài trời hay đi biển.", images: [SITE_IMAGES.collections.tui_xach_9], specifications: { dimensions: "20×13×4cm, Cầm tay", reference: "RRS-GI-009" }, featured: false },
  { slug: "gio_vo_so-010", name: "Kẹp Càng Cua Vỏ Điệp Ngọc Trai Biển", collectionSlug: "gio_vo_so", price: "109.000 VND / chiếc", description: "Túi bucket hình tròn đan lát thủ công, quai đeo vai kết từ chuỗi vỏ sò biển tự nhiên. Thiết kế độc đáo, dễ phối nhiều trang phục khác nhau.", images: [SITE_IMAGES.collections.tui_xach_10], specifications: { dimensions: "Ø22×25cm, Quai dài 45cm", reference: "RRS-GI-010" }, featured: true },
  { slug: "gio_vo_so-011", name: "Kẹp Tóc Nơ Vỏ Sò Pastel", collectionSlug: "gio_vo_so", price: "69.000 VND / cặp", description: "Túi clutch tối giản thanh lịch, viền miệng túi và quai xích đính vỏ sò mạ vàng tinh tế. Phù hợp mang đi sự kiện, tiệc cưới hoặc chụp ảnh ngoại cảnh.", images: [SITE_IMAGES.collections.tui_xach_11], specifications: { dimensions: "24×15×3cm, Xích dài 60cm", reference: "RRS-GI-011" }, featured: false },
  ...
  { slug: "vong_tay-005", name: "Vòng Tay Chuỗi Hạt Vỏ Sò Nhiều Màu", collectionSlug: "vong_tay", price: "95.000 VND", description: "Vòng tay chuỗi hạt vỏ sò biển nhiều màu sắc tươi tắn, mỗi hạt được mài tròn nhẵn mịn. Màu sắc tự nhiên không nhuộm, nhẹ nhàng dịu mắt, phù hợp đeo đi biển hay dạo phố mùa hè.", images: [SITE_IMAGES.collections.vong_tay_5], specifications: { dimensions: "Điều chỉnh 14–19cm", reference: "RRS-VT-005" }, featured: false },
  { slug: "vong_tay-006", name: "Lắc Tay Bạc Đính Mặt Vỏ Điệp Xà Cừ", collectionSlug: "vong_tay", price: "125.000 VND", description: "Lắc tay bạc 925 thanh lịch đính mặt vỏ điệp xà cừ tự nhiên ánh ngũ sắc. Khóa tôm chắc chắn, thiết kế tinh tế phù hợp đeo đi làm, đi học hay các dịp đặc biệt.", images: [SITE_IMAGES.collections.vong_tay_6], specifications: { dimensions: "Chu vi 16–18cm, Khóa tôm", reference: "RRS-VT-006" }, featured: true },
  { slug: "vong_tay-007", name: "Vòng Tay Đan Dây Macramé Kết Hợp Vỏ Ốc", collectionSlug: "vong_tay", price: "85.000 VND", description: "Vòng tay đan dây macramé thủ công phong cách bohemian, kết hợp vỏ ốc biển tự nhiên làm điểm nhấn. Dây cotton bền đẹp, có thể điều chỉnh kích cỡ tự do qua nút trượt.", images: [SITE_IMAGES.collections.vong_tay_7], specifications: { dimensions: "Điều chỉnh tự do qua nút trượt", reference: "RRS-VT-007" }, featured: false },
  { slug: "vong_tay-008", name: "Vòng Tay Ngọc Trai Nước Ngọt Xen Vỏ Sò", collectionSlug: "vong_tay", price: "155.000 VND", description: "Vòng tay kết hợp ngọc trai nước ngọt tự nhiên và mảnh vỏ sò điệp xen kẽ tạo nên sự cân bằng giữa sang trọng và gần gũi với thiên nhiên. Dây đàn hồi thoải mái khi đeo.", images: [SITE_IMAGES.collections.vong_tay_8], specifications: { dimensions: "Chu vi 16–17cm, Dây đàn hồi", reference: "RRS-VT-008" }, featured: false },
  { slug: "vong_tay-009", name: "Vòng Tay Chuỗi Vàng Charm Vỏ Sò Mini", collectionSlug: "vong_tay", price: "135.000 VND", description: "Vòng tay xích mạ vàng 14K nhẹ nhàng đính các charm vỏ sò mini xinh xắn. Thiết kế layering dễ phối cùng các vòng khác, tạo phong cách tự do thoải mái mà vẫn tinh tế.", images: [SITE_IMAGES.collections.vong_tay_9], specifications: { dimensions: "Điều chỉnh 14–18cm, Xích vàng", reference: "RRS-VT-009" }, featured: false },
];
